...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=4.5in]{images/flow.png}
	\caption{\thefigure\ User Flow diagrama, piešta su Moqups.}
\end{figure}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=3in]{images/interface.png}
	\caption{\thefigure\ Pagrindinis funkcionalumas, piešta su Moqups.}
\end{figure}
